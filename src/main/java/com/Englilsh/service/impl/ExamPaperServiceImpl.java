...
import com.Englilsh.domain.exam.ExamPaperQuestionItemObject;
...
import com.Englilsh.service.enums.ActionEnum;
...
import com.Englilsh.viewmodel.admin.exam.ExamPaperTitleItemVM;
...
public class ExamPaperServiceImpl extends BaseServiceImpl<ExamPaper> implements ExamPaperService {
    ...
    public ExamPaperEditRequestVM examPaperToVM(Integer id) {
        ...
        vm.setLevel(examPaper.getSubjectLevel());
        TextContent frameTextContent = textContentService.selectById(examPaper.getFrameTextContentId());
    ...
    public List<Integer> getAllLevel() {
        return examPaperMapper.getAllLevel();
    }
...
//        Integer gradeLevel = subjectService.levelBySubjectId(examPaperEditRequestVM.getSubjectId());
        ...
        examPaper.setSubjectLevel(examPaperEditRequestVM.getLevel());
