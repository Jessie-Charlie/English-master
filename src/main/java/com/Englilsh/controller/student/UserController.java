...
import com.Englilsh.domain.enums.RoleEnum;
...
import com.Englilsh.service.MessageService;
import com.Englilsh.service.UserEventLogService;
...
import com.Englilsh.viewmodel.student.user.*;
...
public class UserController extends BaseApiController {
    ...
    public RestResponse register(@RequestBody @Valid UserRegisterVM model) {
        ...
        userEventLog.setContent("欢迎 " + user.getUserName() + " 注册来到英语刷题系统，祝您学习顺利！");
